...
This table lists the configuration variables required to operate Libraesva. These variables are specified when configuring a libraesva asset in Splunk SOAR.
